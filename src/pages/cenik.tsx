...
const Cenik: NextPage = () => {
    ...
    const [cena2, setCena2] = useState("790,- Kč");
        ...
        <section className={styles.content}>
            <section className={styles.boxwrapper}>
                ...
                <section className={styles.gridwrapper}>
                    ...
                    <p className={styles.griditem9}>790,- Kč</p>
                    <p className={styles.griditem10} id=''>4. a další sezení</p>
                    <p className={styles.griditem11}>790,- Kč</p>
                    <p className={styles.griditem12}>790,- Kč</p>
                    <p className={styles.griditem13}>790,- Kč</p>
                    <p className={styles.griditem14}>690,- Kč</p>
                </section>
